...
Effective Date: July 15th 2015</h2>

Drago collects information about you when you use our mobile applications, websites, and other online products and services (collectively, the “Services”) and through other interactions and communications you have with us. If you reside in the United States, the Services are provided by 2OAK GROUP dba Drago LLC and its U.S. affiliates (collectively “Drago”), and this Privacy Statement applies to information collected and used by Drago. If you reside outside of the United States, the Services are provided by Drago B.V., and this Privacy Statement applies to information collected and used by Drago B.V. (Drago U.S. and Drago B.V. are referred to herein collectively as Drago or “we”).
...
Call and SMS Data: Our Services facilitate communications between Users and Gyms. In connection with facilitating this service, we receive call data, including the date and time of the call or SMS message, the parties’ phone numbers, and the content of the SMS message.
...
Send or facilitate communications (i) between you and a Gym, such as check in and check out or (ii) between you and a contact of yours at your direction in connection with your use of certain features, such as referrals, or invites;
Send you communications we think will be of interest to you, including information about products, services, promotions, news, and events of Drago and other companies, where permissible and according to local applicable laws; and to process contest, sweepstake, or other promotion entries and fulfill any related awards;
...
With your employer (or similar entity) and any necessary third parties engaged by us or your employer (e.g., an expense management service provider), if you participate in any of our enterprise solutions such as Drago for Business. SAVE THIS USE FOR WHEN/IF WE PARTNER WITH INSURANCE COMPANIES
Other Important Sharing

We may share your information:

With Drago subsidiaries and affiliated entities that provide services or conduct data processing on our behalf, or for data centralization and / or logistics purposes;
...
With law enforcement officials, government authorities, or other third parties if we believe your actions are inconsistent with our Drago agreements, Terms of Service, or policies, or to protect the rights, property, or safety of Drago or others;
...
You may correct your account information at any time by logging into your online or in-app account. If you wish to cancel your account, please email us at helpme@drago.nyc. Please note that in some cases we may retain certain information about you as required by law, or for legitimate business purposes to the extent permitted by law. For instance, if you have a standing credit or debt on your account, or if we believe you have committed fraud or violated our Terms, we may seek to resolve the issue before deleting your information.

Access Rights

Drago will comply with individual’s requests regarding access, correction, and/or deletion of the personal data it stores in accordance with applicable law.

Location Information

We request permission for our app’s collection of precise location from your device per the permission system used by your mobile operating system. If you initially permit the collection of this information, you can later disable it by changing the location settings on your mobile device. However, this will limit your ability to use certain features of our Services. Additionally, disabling our app’s collection of precise location from your device will not limit our ability to collect your workout information from a Gyms's device nor our ability to derive approximate location from your IP address.
...
If you have any questions about this Privacy Statement, please contact us at privacy@drago.nyc.